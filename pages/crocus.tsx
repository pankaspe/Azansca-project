         ...
         >
            <Box mt={{ base: 4, md: 0 }} mr={{ md: 6 }}>
               ...
               <Text mt={2}>
                  ...
                  Il nostro consiglio è di lasciarlo a bagno maria per circa un&apos;ora, passata la quale l&apos;acqua avr&aacute; preso un colorito giallo intenso tendente all&apos;arancione, pronta per essere utilizzata nella pietanza prima di essere servita! 
                  Se ne sconsiglia la cottura per evitare di disperdere le propriet&aacute; della spezia.
               </Text>
